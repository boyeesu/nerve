...
ManClaw community a harassment-free experience for everyone, regardless of age,
...
[maintainer's GitHub profile](https://github.com/boyeesu). Do not open a public
issue containing sensitive personal information.
...
1. **Correction** — A private written warning with clarification of the
   violation and expected behavior.
2. **Warning** — A warning with consequences for continued behavior and a
   temporary restriction on interaction.
3. **Temporary ban** — A temporary ban from public interaction with the
   community.
4. **Permanent ban** — Permanent removal for sustained inappropriate behavior,
